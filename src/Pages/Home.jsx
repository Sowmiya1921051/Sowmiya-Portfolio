            ...
            <Box id="aboutMe">
                ...
                <Flex flexDirection={['column-reverse', 'column-reverse', 'column-reverse', 'row']} alignItems="center" h="100%">
                    ...
                    <Flex data-aos="fade-left">
                        ...
                        <Box>
                            <Text>Experienced web developer with a strong background in Java, HTML, CSS, React.js, Tailwind CSS, and Python.
                                Completed B.Tech in IT, showcasing a solid understanding of programming principles and web technologies.
                                Proficient in full-stack development, adept at building dynamic web applications and collaborating with teams.
                                Demonstrated expertise in front-end frameworks like React.js and skilled in backend development using Python and frameworks like Django.
                                Strong problem-solving skills, with a track record of delivering high-quality projects on time and exceeding client expectations.
                                Committed to continual learning, staying updated with industry trends, and actively contributing to the web development community.</Text>
                        </Box>
                    </Flex>
                </Flex>
            </Box>
                ...
                <Flex flexDirection={["column", "column", "column", "row"]} alignItems="center">
                    ...
                    <Box className='form-section'>
                        ...
                        <Flex gap={["10px", "20px", "20px", "40px"]}>
                            ...
                            <Link href='https://www.linkedin.com/in/sowmiya-n-06ba2b221/' target="_blank">
                            ...
                            <Link href="https://github.com/Sowmiya1921051" target="_blank">
                                <Tooltip label='Sowmiya1921051'>
                                    <Box className='social-icons'>
                                        <Box>
